(ns gov.stockport.sonar.visualise.ui.pages.home-orig
  (:require [reagent.core :as reagent :refer [atom]]
            [ajax.core :refer [GET]]
            [cljs-time.format :as f]
            [goog.crypt.base64 :as b64]
            [gov.stockport.sonar.visualise.ui.explore :refer [graph view-state]]
            [gov.stockport.sonar.visualise.ui.records :refer [record-list]]
            [gov.stockport.sonar.visualise.query.client :refer [query ->json]]
            [gov.stockport.sonar.visualise.common.query.base :as qb]
            [gov.stockport.sonar.visualise.util.date :as d]
            [gov.stockport.sonar.visualise.ui.facet :refer [->cs facet-tree]]
            [cljs-time.core :as t]))
