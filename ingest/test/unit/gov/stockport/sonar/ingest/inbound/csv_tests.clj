...
(facts "csv mapper"
       ...
       (fact "can provide mapped data"
             ((csv/mapper "some") 1 "data") => {:idx  1
                                                :data {:some "data"}})

       (fact "can handle multiple columns"
             ((csv/mapper "some,more,columns") 2 "data1,data2,data3") => {:idx  2
                                                                          :data {:some    "data1"
                                                                                 :more    "data2"
                                                                                 :columns "data3"}})

       (fact "can handle blank columns"
             ((csv/mapper "some,more,columns") 3 "data1,,data3") => {:idx  3
                                                                     :data {:some    "data1"
                                                                            :more    ""
                                                                            :columns "data3"}})
       ...
       (fact "will reject data if expected columns don't match"
             ((csv/mapper "some,columns") 1 "data") => {:idx   1
